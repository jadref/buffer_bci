function [clsfr,f,fraw,p,X,isbadtr,isbadch]=buffer_apply_erp_clsfr(X,clsfr,verb)
% apply a previously trained classifier to the input data
% 
%  [clsfr,f]=buffer_apply_erp_clsfr(X,clsfr,verb)
%
% Inputs:
...
[clsfr, f, fraw, p, X, isbadtr, isbadch]=apply_erp_clsfr(X,clsfr,verb);
