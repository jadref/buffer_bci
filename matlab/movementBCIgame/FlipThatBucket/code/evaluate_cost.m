...
% - Pr(probe-action == T) = 1/5 for T = [-inf,-2]
% - Pr(probe-action == T) = 3/5 for T = [-2,0]
...
desired_fraction_probes_before_intention = 1/5;
...
C4 = 10^10; % cost early prediction
C5 = 10^10; % cost late prediction
