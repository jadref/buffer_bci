...
'Units','normalized',...
'Position',[0.0871559633027523 0.750759878419453 0.448623853211009 0.21580547112462],...
'Tag','preproc',...
'Behavior',struct(),...
'SelectedObject',[],...
...
'Units','normalized',...
'Position',[0.0688073394495413 0.340425531914894 0.448623853211009 0.258358662613982],...
'Tag','spatfilt',...
'Behavior',struct(),...
'SelectedObject',[],...
'SelectionChangeFcn',@(o,v) setappdata(gcbf(),get(o,'tag'),get(get(o,'SelectedObject'),'String')),...
...
'Units','normalized',...
'Position',[0.5688073394495413 0.340425531914894 0.448623853211009 0.358358662613982],...
'Tag','adaptfilt',...
'UserData',[]);
catch
  h13=[];
...
'Units','normalized',...
'FontSize',8,...
'Position',[0.0451977401129944 0.55 0.898305084745763 0.202380952380952],...
'String','whiten',...
'Style','checkbox',...
'Value',0,...
'Tag','whiten',...
...
'Units','normalized',...
'FontSize',8,...
'Position',[0.0451977401129944 0.347619047619048 0.898305084745763 0.202380952380952],...
'String','rmArtCh',...
'Style','checkbox',...
'Value',0,...
'Tag','rmartch',...
...
'Units','normalized',...
'FontSize',8,...
'Position',[0.0451977401129944 0.145238095238095 0.898305084745763 0.202380952380952],...
'String','rmEMG',...
'Style','checkbox',...
'Value',0,...
'Tag','rmemg',...
