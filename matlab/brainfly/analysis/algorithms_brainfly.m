...
## algorithms{end+1}={'adaptwht30s_predbiasfilt30' 'spatialfilter','none','adaptspatialfiltFn',{'adaptWhitenFilt','covFilt',s2samp(30)},'featFiltFn',{'biasFilt' s2calls(30)}};
...
## algorithms{end+1}={'adaptwht60s_predbiasfilt30' 'spatialfilter','none','adaptspatialfiltFn',{'adaptWhitenFilt','covFilt',s2samp(60)},'featFiltFn',{'biasFilt' s2calls(30)}};
algorithms{end+1}={'adaptwht60s_predbiasfilt60' 'spatialfilter','none','adaptspatialfiltFn',{'adaptWhitenFilt','covFilt',s2samp(60)},'featFiltFn',{'biasFilt' s2calls(60)}};
## algorithms{end+1}={'adaptwht60s_predbiasfilt15' 'spatialfilter','none','adaptspatialfiltFn',{'adaptWhitenFilt','covFilt',s2samp(60)},'featFiltFn',{'biasFilt' s2calls(15)}};
## algorithms{end+1}={'wht_stdfilt60' 'spatialfilter','wht','featFiltFn',{'stdFilt' s2calls(60)}};
## algorithms{end+1}={'wht_stdfilt300_predbiasfilt60' 'spatialfilter','wht','featFiltFn',{'stdFilt' s2calls(300)},'predFiltFn',{'biasFilt' s2calls(60)}};
## algorithms{end+1}={'wht_stdfilt30_predbiasfilt30' 'spatialfilter','wht','featFiltFn',{'stdFilt' s2calls(30)},'predFiltFn',{'biasFilt' s2calls(30)}};
## algorithms{end+1}={'wht_predbiasfilt60' 'spatialfilter','wht','predFiltFn',{'biasFilt' s2calls(60)}};
algorithms{end+1}={'wht_predbiasfilt30s' 'spatialfilter','wht','predFiltFn',{'biasFilt' s2calls(30)}};
## algorithms{end+1}={'wht_predbiasfilt15s' 'spatialfilter','wht','predFiltFn',{'biasFilt' s2calls(15)}};
