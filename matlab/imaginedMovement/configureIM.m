...
%trainOpts={'width_ms',welch_width_ms,'badtrrm',0,'spatialfilter','trwht','adaptspatialfiltFn',trialadaptfactor,'objFn','mlr_cg','binsp',0,'spMx','1vR'}; % adaptive-whiten + direct multi-class training
%trainOpts={'width_ms',welch_width_ms,'badtrrm',0,'spatialfilter','adaptspatialfilt','adaptspatialfiltFn',{'artChRegress',[],{'EOG' 'AF3' 'AFz' 'AF4'}},'objFn','mlr_cg','binsp',0,'spMx','1vR'}; % eog-removal + direct multi-class training
%trainOpts={'width_ms',welch_width_ms,'badtrrm',0,'spatialfilter','adaptspatialfilt','adaptspatialfiltFn',{'rmEMGFilt',[1 2 3]},'objFn','mlr_cg','binsp',0,'spMx','1vR'}; % emg-removal + direct multi-class training
%trainOpts={'width_ms',welch_width_ms,'badtrrm',0,'spatialfilter','adaptspatialfilt','adaptspatialfiltFn',{'filtPipeline' {'rmEMGFilt',[1 2 3]} {'artChRegress',[],{'C3' 'C4'}}},'objFn','mlr_cg','binsp',0,'spMx','1vR'}; % (emg-removal->eog-removal) + direct multi-class training
