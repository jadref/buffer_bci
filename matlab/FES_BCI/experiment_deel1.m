...
% make the stimuli
[msgh,square,fig]=init_stim(neutralColor,textColor); %define figure settings
...
for b=1:nr_blocks
    ...
    for si=1:nSeq;
        ...
        if nr_taps > 2
            calcDistribution = true;
            [t_FES, muProbe, sigmaProbe, probeOnset] = getProbeOnsetV2(human_stats,calcDistribution); %t_FES=human_stats.mu+randsample(-2:2,1,true,[0.5 0.5 0.25 0.25 0.25]); 
        end
