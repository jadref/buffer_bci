...
if %ismatlab%==1 (
  ...
  echo run ../../utilities/initPaths.m;startSigProcBuffer^('epochEventType','stimulus.target','testepochEventType','stimulus.image','freqband',[.1 1 10 12],'clsfr_type','erp','trlen_ms',700^);quit | %matexe% %matopts%
)