...
function h1 = sigProcOpts_LayoutFcn(policy)
...
setappdata(h1,get(h12,'tag'),get(get(h12,'SelectedObject'),'String')),...    
...
'Parent',h1,...
'Units','normalized',...
'Position',[0.0871559633027523 0.629179331306991 0.784403669724771 0.0638297872340425],...
'String','Bad Channel Removal',...
'Style','checkbox',...
'Value',1,...
'Tag','badchrm',...
