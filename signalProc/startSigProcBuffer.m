...
while ( true )
  ...
  switch lower(phaseToRun);
   ...
   case {'erspvis','erpvis','erpviewer','erpvisptb'};
    [X,Y,key]=erpViewer(opts.buffhost,opts.buffport,'capFile',capFile,'overridechnms',overridechnms,'cuePrefix',opts.erpEventType,'endType',lower(phaseToRun),'trlen_ms',opts.trlen_ms,'freqbands',[.0 .3 45 47],'maxEvents',opts.erpMaxEvents);
