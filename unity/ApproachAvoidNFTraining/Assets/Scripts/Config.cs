...
public class Config : MonoBehaviour {
	...
	public static string questionaireText = "Goed gedaan! Nu volgt een korte vragenlijst waarin we u een aantal vragen stellen over hoe u zich op dit moment voelt. \n U kunt uw antwoord geven door met uw vinger de stippen te verschuiven";
	...
	public static float eyesOpenDuration = 60;
