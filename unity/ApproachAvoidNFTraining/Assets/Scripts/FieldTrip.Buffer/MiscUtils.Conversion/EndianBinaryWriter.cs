...
namespace MiscUtil.IO
{
	...
	public class EndianBinaryWriter : IDisposable
	{
		...
		public void Write(string value)
		{
			...
			//Write7BitEncodedInt(data.Length); //I don't know why that was here in the original code but it adds an extra byte to the buffer and everything gets out of whack!!!!!
			WriteInternal(data, data.Length);
		}
