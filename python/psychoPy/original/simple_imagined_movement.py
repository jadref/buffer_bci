...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.06), ma 28 jul 2014 15:30:01 CEST
...
# buffer_bci Defining a usefull helper function

def sendEvent(type, value):
    e = Event()
    e.type = type
    e.value = value
    ftc.putEvents(e)
