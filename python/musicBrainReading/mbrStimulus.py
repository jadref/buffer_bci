...
# Path of the folder containing fieldtrip.py
...
def runTrainingEpoch(nEpoch):
    ...
    nr_lowered = randint(0,number_of_stimuli)
    ...
    for i in range(0,len(set_sequence)):
    	newSet = [set_sequence[i], set_sequence[i], set_sequence[i]]
    	if low_sequence[i]:
