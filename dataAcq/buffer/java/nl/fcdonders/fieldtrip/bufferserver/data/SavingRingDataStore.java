	...
	public SavingRingDataStore(final int nSamples, final int nEvents) {
	 ...
	 void initFiles(String path){
		 ...
		 try {
			  ...
			  dataWriter = 
					new BufferedOutputStream(new FileOutputStream(fullpath+File.separator+"samples"),
													 dataBufSize);
			  eventWriter = new BufferedOutputStream(new FileOutputStream(fullpath+File.separator+"events"),
																  eventBufSize);
			  headerWriter = new BufferedOutputStream(new FileOutputStream(fullpath+File.separator+"header"));
