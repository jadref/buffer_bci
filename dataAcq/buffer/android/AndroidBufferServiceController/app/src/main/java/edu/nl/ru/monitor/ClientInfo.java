...
public class ClientInfo implements Parcelable {
    ...
    public String toString() {
        return "ClientInfo: {address=" + address + ", clientID=" + clientID + ", timeLastActivity=" +
    ...
    public void writeToParcel(final Parcel out, final int flags) {
        // Gathering data
        final int[] integers = new int[]{clientID, samplesGotten, samplesPut, eventsGotten, eventsPut, lastActivity,
