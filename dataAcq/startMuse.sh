...
java -cp buffer/java/Buffer.jar:osc/JavaOSC/JavaOSC.jar:osc osc2ft /muse/eeg/raw:1234 localhost:1972 6 500 1 10 &
...
$buffexe --device ffc3 --preset ab --osc osc.udp://localhost:1234
if [ $? -neq 0 ]; then
