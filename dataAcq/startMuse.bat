...
set oscport=1234
set oscdevice=6B38
start "osc2ft" %javaexe% -cp "%batdir%/buffer/java/BufferClient.jar;%batdir%/buffer/java/JavaOSC.jar;%batdir%/buffer/java" osc2ft /muse/eeg:%oscport% localhost:1972 4 220 1 10
