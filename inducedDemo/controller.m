...
% Last Modified by GUIDE v2.5 10-Oct-2013 12:15:48
...
% --- Executes on button press in erspvis.
function erspvis_Callback(hObject, eventdata, handles)
% hObject    handle to erspvis (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.phaseToRun=get(hObject,'Tag');
guidata(hObject,handles);
