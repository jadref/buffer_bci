...
public class BufferBciInput {
    ...
    private boolean haveRecvThread;

    /**
     * Initializes the BufferBciInput instance.
     */
    public BufferBciInput(boolean recvThread) {
        this(10, recvThread);
    }
     ...
     * Initializes the BufferBciInput instance.
     */
    public BufferBciInput(int timeout, boolean recvTread) {
        this.timeout = timeout;
        this.haveRecvThread = recvTread;
    ...
    public BufferClient getBufferClient() {
        return client;
    }
