...
class CursorStimulusScreen implements Screen,CursorScreen {
    ...
    CursorScreen(final Game gam, int nSymb) { // Initialize variables
        game=gam; nSymbs=nSymb;
    }
    ...
    // TODO []: update to use gdx drawing commands
    void draw(){
