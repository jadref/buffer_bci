...
private String Ip;
ControlP5 cp;
private ProcessingSigViewer_V2_Android parent;
...
public OtherSketch(ProcessingSigViewer_V2_Android parent, ProcessingSigViewer_Model model, ProcessingSigViewer_View view, ProcessingSigViewer_Controller controller)
  {
    ...
    ////This will actually launch the new sketch on the java version
