...
public class ProcessingSigViewer_View {  
  ...
  private void addOptionButtons() {
    ...
    c1.moveTo("global");
    t1 = controlP5.addTextfield("").setPosition((int)(0.03*width), (int)(0.37*height)).setSize((int)(0.15*width), (int)(0.03*width));
    t1.moveTo("global");
    ...
    //Spectral Filter
    t2 = controlP5.addTextfield("Low Cut-Off").setPosition((int)(0.03*width), (int)(0.82*height)).setSize((int)(0.15*width), (int)(0.03*height));
    t2.moveTo("global"); 
    t3 = controlP5.addTextfield("High Cut-Off").setPosition((int)(0.03*width), (int)(0.91*height)).setSize((int)(0.15*width), (int)(0.03*height));
    t3.moveTo("global");
  }
  ...
  private void drawBoxes() {
    ...
    rect((0.125*width), (0.45*height), (0.079*width), (0.3*height));
    //  rect belonging to Bad chan RM
    rect((0.025*width), (0.29*height), (0.17*width), (0.14*height));
