...
start /b dataAcq/startJavaNoSaveBuffer.bat
...
if %dataacq%=="audio" (
  start /b dataAcq/startJavaAudio.bat localhost 2
) else if %dataacq%=="matlab" (
  start /b dataAcq/startMatlabSignalProxy.bat
) else (
  start /b dataAcq/startJavaSignalproxy.bat
)
rem dataacqpid=$!
...
start /b signalProc/startSigProcBuffer.bat
rem sigprocpid=$!
