...
%  alpha         -- [float] decay constant for exp-weighted moving average, N.B. alpha = exp(log(.5)/halflife)
...
global rtclockmb rtclockrecord; % clock sync info for prediction event sending
...
while( ~endTest )
  ...
  % periodically update the clock alignment
