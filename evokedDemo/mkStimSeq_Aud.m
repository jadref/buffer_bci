function [stimSeq,stimTime,eventSeq,colors, audio]=mkStimSeq_Aud(h,duration,isi,tti,oddp)
...
if ( oddp ) stimSeq(1,2:2:end-1)=-5; stimSeq(4,2:2:end-1)=3;end;
...
beep = wavread('auditoryStimuli/550.wav'); %oddball
beepStd = audioplayer(beep, 44100);
beep = wavread('auditoryStimuli/500.wav'); %standard
beepOdd = audioplayer(beep, 44100);
